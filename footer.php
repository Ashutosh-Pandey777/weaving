		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4 footer-grid-agileits-w3ls text-left">
					<h3>About US</h3>
					<p><?php getshortdescription("about"); ?></p>
					<div class="read">
			...
			<div class="footer-cpy text-center">
				<div class="footer-social">
					<div class="copyrighttop">
						<ul>
							...
							<li class="mx-3">
								<a class="facebook" href="<?php getlinks("links","youtube");?>">
				...
				<div class="w3layouts-agile-copyrightbottom">
					<p> Weaving Synergies Site <?php $current=date("Y"); print_r($current);?> | Brought To You by Ashutosh Pandey
