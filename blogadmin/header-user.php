      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li><a href="about_view.php"><i class="fa fa-check"></i>About</a></li>
            <li><a href="gallery_view.php"><i class="fa fa-tasks"></i>gallery</a></li>
            <li><a href="magazines_view.php"><i class="fa fa-tasks"></i>E-magazine</a></li>
            <li><a href="events_view.php"><i class="fa fa-tasks"></i>Event</a></li>
            <li><a href="#"><i class="fa fa-tasks"></i>Soft-Skils</a></li>
            <?php
