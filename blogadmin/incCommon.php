	...
	*/
	...
	function getTableList($skip_authentication = false){
		...
		$arrTables = array(
			...
			'about' => array('About', '', 'resources/table_icons/drugs_com.png', 'None'), 
			'titles' => array('Website Details', '', 'resources/table_icons/drugs_com.png', 'None'),
			'soft_skill' => array('Soft-Skill', '', 'resources/table_icons/feed.png', 'None'),
			...
			'gallery' => array('Gallery', '', 'resources/table_icons/feed.png', 'None'),
			'magazines' => array('E-Magazines', '', 'resources/table_icons/feed.png', 'None'),
			'events' => array('Events', '', 'resources/table_icons/feed.png', 'None'),
	...
	function get_sql_fields($table_name){
		$sql_fields = array(   
			'about' => "`about`.`id` as 'id', `blogs`.`title` as 'title', IF(    CHAR_LENGTH(`blog_categories1`.`name`), CONCAT_WS('',   `blog_categories1`.`name`), '') as 'category', `blogs`.`tags` as 'tags', `blogs`.`content` as 'content', `blogs`.`photo` as 'photo', if(`blogs`.`date`,date_format(`blogs`.`date`,'%m/%d/%Y'),'') as 'date', `blogs`.`author` as 'author', `blogs`.`posted` as 'posted'",
			...
			'gallery' => "`gallery`.`id` as 'id', `blogs`.`title` as 'title', IF(    CHAR_LENGTH(`blog_categories1`.`name`), CONCAT_WS('',   `blog_categories1`.`name`), '') as 'category', `blogs`.`tags` as 'tags', `blogs`.`content` as 'content', `blogs`.`photo` as 'photo', if(`blogs`.`date`,date_format(`blogs`.`date`,'%m/%d/%Y'),'') as 'date', `blogs`.`author` as 'author', `blogs`.`posted` as 'posted'",
			'magazines' => "`magazines`.`id` as 'id', `blogs`.`title` as 'title', IF(    CHAR_LENGTH(`blog_categories1`.`name`), CONCAT_WS('',   `blog_categories1`.`name`), '') as 'category', `blogs`.`tags` as 'tags', `blogs`.`content` as 'content', `blogs`.`photo` as 'photo', if(`blogs`.`date`,date_format(`blogs`.`date`,'%m/%d/%Y'),'') as 'date', `blogs`.`author` as 'author', `blogs`.`posted` as 'posted'",
			'soft_skill' => "`soft_skill`.`id` as 'id', `blogs`.`title` as 'title', IF(    CHAR_LENGTH(`blog_categories1`.`name`), CONCAT_WS('',   `blog_categories1`.`name`), '') as 'category', `blogs`.`tags` as 'tags', `blogs`.`content` as 'content', `blogs`.`photo` as 'photo', if(`blogs`.`date`,date_format(`blogs`.`date`,'%m/%d/%Y'),'') as 'date', `blogs`.`author` as 'author', `blogs`.`posted` as 'posted'",
			'events' => "`events`.`id` as 'id', `blogs`.`title` as 'title', IF(    CHAR_LENGTH(`blog_categories1`.`name`), CONCAT_WS('',   `blog_categories1`.`name`), '') as 'category', `blogs`.`tags` as 'tags', `blogs`.`content` as 'content', `blogs`.`photo` as 'photo', if(`blogs`.`date`,date_format(`blogs`.`date`,'%m/%d/%Y'),'') as 'date', `blogs`.`author` as 'author', `blogs`.`posted` as 'posted'",
	...
	function get_sql_from($table_name, $skip_permissions = false){
		$sql_from = array( 
			'about' => "`about` LEFT JOIN `blog_categories` as blog_categories1 ON `blog_categories1`.`id`=`blogs`.`category` ",
			'soft_skill' => "`soft_skill` ",
			'titles' => "`titles` ",
			'links' => "`links` ",
			'blog_categories' => "`blog_categories` ",
			'blogs' => "`blogs` LEFT JOIN `blog_categories` as blog_categories1 ON `blog_categories1`.`id`=`blogs`.`category` ",
			'gallery' => "`gallery` LEFT JOIN `blog_categories` as blog_categories1 ON `blog_categories1`.`id`=`blogs`.`category` ",
			'magazines' => "`magazines` LEFT JOIN `blog_categories` as blog_categories1 ON `blog_categories1`.`id`=`blogs`.`category` ",
			'events' => "`events` LEFT JOIN `blog_categories` as blog_categories1 ON `blog_categories1`.`id`=`events`.`category` ",
