...
function links_insert(){
	...
	$data['instagram'] = makeSafe($_REQUEST['instagram']);
		if($data['instagram'] == empty_lookup_value){ $data['instagram'] = ''; }
	$data['youtube'] = makeSafe($_REQUEST['youtube']);
		if($data['youtube'] == empty_lookup_value){ $data['youtube'] = ''; }
	$data['linkedin'] = makeSafe($_REQUEST['linkedin']);
		if($data['linkedin'] == empty_lookup_value){ $data['linkedin'] = ''; }
	...
	sql('insert into `links` set       `facebook`=' . (($data['facebook'] !== '' && $data['facebook'] !== NULL) ? "'{$data['facebook']}'" : 'NULL') . ', `twitter`=' . (($data['twitter'] !== '' && $data['twitter'] !== NULL) ? "'{$data['twitter']}'" : 'NULL') . ', `instagram`=' . (($data['instagram'] !== '' && $data['instagram'] !== NULL) ? "'{$data['instagram']}'" : 'NULL') . ', `youtube`=' . (($data['youtube'] !== '' && $data['youtube'] !== NULL) ? "'{$data['youtube']}'" : 'NULL') . ', `linkedin`=' . (($data['linkedin'] !== '' && $data['linkedin'] !== NULL) ? "'{$data['linkedin']}'" : 'NULL') . ', `comments_script`=' . (($data['comments_script'] !== '' && $data['comments_script'] !== NULL) ? "'{$data['comments_script']}'" : 'NULL') . ', `sharing_script`=' . (($data['sharing_script'] !== '' && $data['sharing_script'] !== NULL) ? "'{$data['sharing_script']}'" : 'NULL') . ', `javascript`=' . (($data['javascript'] !== '' && $data['javascript'] !== NULL) ? "'{$data['javascript']}'" : 'NULL'), $o);
	if($o['error']!=''){
		echo $o['error'];
...
function links_update($selected_id){
	...
	$o=array('silentErrors' => true);
	sql('update `links` set       `facebook`=' . (($data['facebook'] !== '' && $data['facebook'] !== NULL) ? "'{$data['facebook']}'" : 'NULL') . ', `twitter`=' . (($data['twitter'] !== '' && $data['twitter'] !== NULL) ? "'{$data['twitter']}'" : 'NULL') . ', `instagram`=' . (($data['instagram'] !== '' && $data['instagram'] !== NULL) ? "'{$data['instagram']}'" : 'NULL') . ', `youtube`=' . (($data['youtube'] !== '' && $data['youtube'] !== NULL) ? "'{$data['youtube']}'" : 'NULL') . ', `linkedin`=' . (($data['linkedin'] !== '' && $data['linkedin'] !== NULL) ? "'{$data['linkedin']}'" : 'NULL') . ', `comments_script`=' . (($data['comments_script'] !== '' && $data['comments_script'] !== NULL) ? "'{$data['comments_script']}'" : 'NULL') . ', `sharing_script`=' . (($data['sharing_script'] !== '' && $data['sharing_script'] !== NULL) ? "'{$data['sharing_script']}'" : 'NULL') . ', `javascript`=' . (($data['javascript'] !== '' && $data['javascript'] !== NULL) ? "'{$data['javascript']}'" : 'NULL') . " where `id`='".makeSafe($selected_id)."'", $o);
	if($o['error']!=''){
		echo $o['error'];
...
function links_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = ''){
	...
	if(($selected_id && !$AllowUpdate && !$AllowInsert) || (!$selected_id && !$AllowInsert)){
		...
		$jsReadOnly .= "\tjQuery('#instagram').replaceWith('<div class=\"form-control-static\" id=\"instagram\">' + (jQuery('#instagram').val() || '') + '</div>');\n";
		$jsReadOnly .= "\tjQuery('#youtube').replaceWith('<div class=\"form-control-static\" id=\"youtube\">' + (jQuery('#youtube').val() || '') + '</div>');\n";
		$jsReadOnly .= "\tjQuery('#linkedin').replaceWith('<div class=\"form-control-static\" id=\"linkedin\">' + (jQuery('#linkedin').val() || '') + '</div>');\n";
	...
	$templateCode = str_replace('<%%UPLOADFILE(instagram)%%>', '', $templateCode);
	$templateCode = str_replace('<%%UPLOADFILE(youtube)%%>', '', $templateCode);
	$templateCode = str_replace('<%%UPLOADFILE(linkedin)%%>', '', $templateCode);
	...
	if($selected_id){
		...
		if( $dvprint) $templateCode = str_replace('<%%VALUE(instagram)%%>', safe_html($urow['instagram']), $templateCode);
		if(!$dvprint) $templateCode = str_replace('<%%VALUE(instagram)%%>', html_attr($row['instagram']), $templateCode);
		$templateCode = str_replace('<%%URLVALUE(instagram)%%>', urlencode($urow['instagram']), $templateCode);
		if( $dvprint) $templateCode = str_replace('<%%VALUE(youtube)%%>', safe_html($urow['youtube']), $templateCode);
		if(!$dvprint) $templateCode = str_replace('<%%VALUE(youtube)%%>', html_attr($row['youtube']), $templateCode);
		$templateCode = str_replace('<%%URLVALUE(youtube)%%>', urlencode($urow['youtube']), $templateCode);
		if( $dvprint) $templateCode = str_replace('<%%VALUE(linkedin)%%>', safe_html($urow['linkedin']), $templateCode);
		if(!$dvprint) $templateCode = str_replace('<%%VALUE(linkedin)%%>', html_attr($row['linkedin']), $templateCode);
		$templateCode = str_replace('<%%URLVALUE(linkedin)%%>', urlencode($urow['linkedin']), $templateCode);
		...
		$templateCode = str_replace('<%%VALUE(instagram)%%>', '', $templateCode);
		$templateCode = str_replace('<%%URLVALUE(instagram)%%>', urlencode(''), $templateCode);
		$templateCode = str_replace('<%%VALUE(youtube)%%>', '', $templateCode);
		$templateCode = str_replace('<%%URLVALUE(youtube)%%>', urlencode(''), $templateCode);
		$templateCode = str_replace('<%%VALUE(linkedin)%%>', '', $templateCode);
		$templateCode = str_replace('<%%URLVALUE(linkedin)%%>', urlencode(''), $templateCode);
