		...
		<div class="top-bar_sub_w3layouts container-fluid">
			<div class="row">
				<div class="col-md-4 logo text-left">
					...
					<img src="images/logo.jpeg" height="50" width="50" > 
					<strong>Weaving Synergies</strong><br></a>
					<!-- <h5>Enable Empower Engage</h5></a> -->
				<div class="header">
					<h5>Enable Empower Engage</h5>
				</div>
				</div>
				...
				<div class="col-md-4 top-forms text-center mt-lg-3 mt-md-1 mt-0">
					...
					<span>
						<a href="signup.php">
							<i class="far fa-user"></i> <strong>Sign Up</strong></a>
					</span>
				</div>
				<div class="col-md-4 log-icons text-right">
					...
					<ul class="social_list1 mt-3">
						...
						<li>
							<a href="<?php getlinks("links","instagram");?>" class="instagram3">
								<i class="fab fa-instagram"></i>
							</a>
						</li>
						<li>
							<a href="<?php getlinks("links","youtube");?>" class="youtube4 mx-2">
								<i class="fab fa-youtube"></i>
							</a>
						</li>
						<li>
							<a href="<?php getlinks("links","linkedin");?>" class="linked5">
				...
				<nav class="navbar navbar-expand-lg navbar-light bg-light">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
							...
							<li class="nav-item">
								<a class="nav-link" href="soft-skill.php">Soft-Skill</a>
							</li>
							<li class="nav-item">
